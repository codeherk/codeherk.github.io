...
Python is a simple and easy language to learn. It is one of the languages I recommended to learn in my [**Learn How To Code**](../2020-03-10-learn-how-to-code) post. When learning anything, it is always best to have structure. In my opinion, it would be ideal to learn the fundamental concepts. I will show you the important concepts of programming, but in Python!
