...
img:  learnhowtocode.jpg # Add image post (optional)
---
...
======
Text Editors are fundamental programming tools used for creating computer programs. I’ve used several over time and my favorite so far is [Visual Studio Code](https://code.visualstudio.com/).
...
Head over to the [Official Python Website](python.org/downloads) and select the release for your operating system.
